...
1. Open the **Pricing table** section in your PayGlue dashboard.
2. Click **New table**.
...
For **One-time** and **Subscription**, select a product from your Polar catalog — the checkout URL fills automatically.
