...
> **Note:** [Screenshot — PayPal Business Dashboard: Zahlen & Zahlungen empfangen > Abonnements > Abonnementpläne (empty state with Plan erstellen button)]
...
> **Note:** [Screenshot — Abonnements verwalten: product page showing Inner Circle Jährlich and Inner Circle Monatlich plans with AKTIVIERT status and their Plan IDs]
...
> **Note:** [Screenshot — developer.paypal.com Apps & Credentials list showing Default Application and PayGLue app, with the Sandbox/Live toggle visible]
...
> **Note:** [Screenshot — developer.paypal.com popup: "Want to see live data and credentials? Upgrade your account to PayPal for Business to switch to live mode."]
...
## Step 6: Create a product mapping

Go to [Mappings](/mappings/create) and link each PayPal plan to a Ghost membership tier.

- Select **PayPal** as the provider
- Select the plan from the dropdown
- Choose the Ghost tier to grant

When a subscriber activates a plan, PayGlue will automatically grant the matching tier.
