...
<Steps>
  <Step title="Open Buy Buttons">
    ...
    PLACEHOLDER IMAGE - New button form in dashboard
  </Step>
  ...
  <Step title="Customize appearance">
    ...
    PLACEHOLDER IMAGE - Button styling options
  </Step>
  <Step title="Save and copy the embed code">
    ...
    PLACEHOLDER IMAGE - Embed code visible after saving
  </Step>
  <Step title="Paste into Ghost">
    ...
    PLACEHOLDER IMAGE - HTML card in Ghost editor with embed code pasted
  </Step>
</Steps>
