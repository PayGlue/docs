...
<Steps>
  ...
  <Step title="Customize appearance">
    ...
    <Note>Placeholder: PayGlue Dashboard — Buy Button editor with styling options and live preview</Note>
  </Step>
  ...
  <Step title="Paste into Ghost">
    ...
    <Note>Placeholder: Buy Button embedded in a Ghost post (example result)</Note>
  </Step>
</Steps>
